...
2. [**Day 2**: Introduction to timing libs, heirarchial vs flat synthesis and efficient flop coding style](https://github.com/drvasanthi/SKY130-RTL-Design-and-Synthesis#2-introduction-to-timing-libs-heirarchial-vs-flat-synthesis-and-efficient-flop-coding-styles)
    ...
    2. [Heirarchial vs flat synthesis](https://github.com/drvasanthi/SKY130-RTL-Design-and-Synthesis#ii-heirarchial-vs-flat-synthesis)
    3. [ Various Flop Coding Styles and Optimization](https://github.com/drvasanthi/SKY130-RTL-Design-and-Synthesis#iii-various-flop-coding-styles-and-optimization)
    	1. [Flop with asynchronous set/reset](https://github.com/drvasanthi/SKY130-RTL-Design-and-Synthesis#a-flop-with-asynchronous-setreset)
    	2. [Flop with synchronous set/reset](https://github.com/drvasanthi/SKY130-RTL-Design-and-Synthesis#b-flop-with-synchronous-setreset)
    	3. [Flop with asynchronous and synchronous set/reset](https://github.com/drvasanthi/SKY130-RTL-Design-and-Synthesis#c-flop-with-synchronous-and-asynchronous-setreset)
